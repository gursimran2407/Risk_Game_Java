...
/**
 * "AWTMapCreateContinentView" class in representing a view object for creating continent
 * These properties are labels, text fields, buttons, a pane, and a panel
 *
 * @author gursimransingh
 */
public class AWTMapCreateContinentView extends AWTAbstractView implements IMapCreateContinentView {
     ...
     */
    public AWTMapCreateContinentView() {
        createUI();
        updateUI(null);
    }
