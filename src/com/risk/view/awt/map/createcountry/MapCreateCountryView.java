...
public class MapCreateCountryView extends AWTAbstractView implements IMapCreateCountryView {
     ...
     */
    public MapCreateCountryView(final List<ContinentModel> listOfContinents) {
